...
int main(int a, char const *arguments[])
{
  ...
  */
  ...
  foreach() {
    ...
    D2c[] = 2*(clamp(f[], 0., 1.) * (Ohs-Oha) + Oha)*D2/sqrt(2.0);
    
    tau[] = sqrt(sq(tau_p.x.x[])+sq(tau_qq[])+sq(tau_p.y.y[])+2.0*sq(tau_p.x.y[]))/sqrt(2.0);
