...
folder = 'Video_twobars'  # output folder
    ...
    if not os.path.exists(place):
        ...
        if os.path.exists(name):
            ...
            if (len(segs) == 0):
                ...
                ## V
                cntrl2 = ax.imshow(taus, cmap="hot_r", interpolation='Bilinear', origin='lower', extent=[0, 4, -4, 4], vmax = 2.0, vmin = 0.0)
                ...
                c2.set_label(r"$\log\left(\|\mathbf{\mathcal{D}}\|\right)$",fontsize=TickLabel, labelpad=5)
